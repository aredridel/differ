...
var Differ = exports.Differ = Class.extend({
    init: function() {
    },
    ...
    diffObjects: function(diff, key, type1, prop1, prop2) {
        if (type1 == 'object') {
            ...
            if (objType1 == ObjectType.Array) {
                if (!this.equivalent(prop1, prop2)) {
                    this.createDiff(diff, DiffType.Change, key, prop2);
                }
                return true;
            }
        ...
        if (diff[DiffType.Change]) {
            ...
            for(var i = 0; i < keys.length; i++) {
                ...
                if (obj[key] instanceof Object &&
                    ...
                    this.getObjectType(obj[key]) == ObjectType.Object &&
                    this.getObjectType(diff[DiffType.Change][key]) == ObjectType.Object) {

                    this.applyDiff(obj[key], diff[DiffType.Change][key]);
                } else {
